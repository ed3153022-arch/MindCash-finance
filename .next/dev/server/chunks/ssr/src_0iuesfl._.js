...
"[project]/src/lib/local-auth.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/local-auth.ts [app-ssr] (ecmascript)");
;
;
class AuthService {
    static isSupabaseAvailable() {
        return !!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"]?.auth;
    }
    // =========================
    // SIGN UP
    // =========================
    static async signUp({ email, password, fullName }) {
        try {
            if (!this.isSupabaseAvailable()) {
                return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LocalAuthService"].signUp(email, password, fullName);
            }
    ...
    static async signIn({ email, password }) {
        try {
            if (!this.isSupabaseAvailable()) {
                return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LocalAuthService"].signIn(email, password);
            }
    ...
    static async signOut() {
        try {
            if (!this.isSupabaseAvailable()) {
                return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LocalAuthService"].signOut();
            }
    ...
    static async getCurrentUser() {
        try {
            if (!this.isSupabaseAvailable()) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LocalAuthService"].getCurrentUser();
            }
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
            return data.user;
        } catch  {
            return null;
        }
    ...
    static onAuthStateChange(callback) {
        if (!this.isSupabaseAvailable()) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LocalAuthService"].onAuthStateChange(callback);
        }
        const { data } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange((_event, session)=>{
...
function useAuth() {
    ...
    const refreshAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            ...
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthService"].getCurrentUser();
            setState({
                user,
                loading: false,
                error: null
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const { data: { subscription: authSubscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthService"].onAuthStateChange((user)=>{
    ...
    const signIn = async (email, password)=>{
        try {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthService"].signIn({
                email,
                password
            });
            if (result.success) {
    ...
    const signInWithGoogle = async ()=>{
        try {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthService"].signInWithGoogle();
            if (result?.error) {
                setState((prev)=>({
                        ...prev,
                        loading: false,
    ...
    const signUp = async (email, password, fullName)=>{
        try {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthService"].signUp({
                email,
                password,
                fullName
            });
    ...
    const resetPassword = async (email)=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthService"].resetPassword({
                email
            });
            if (!result.success) {
                setState((prev)=>({
...
;
function LoginPage() {
    const { signInWithGoogle, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
...
//# sourceMappingURL=src_0iuesfl._.js.map