            ...
            <div className="space-y-5 mb-8 px-2">
              ...
              <div>
                ...
                <input 
                  ...
                  inputMode="numeric"
                  value={newFixed.due_date} 
                  onChange={(e)=>setNewFixed({...newFixed, due_date: maskDate(e.target.value)})} 
                  className="w-full bg-black border border-white/10 p-4 rounded-2xl text-xs font-black italic outline-none focus:border-yellow-400 text-white" 
                />
              </div>
            </div>
