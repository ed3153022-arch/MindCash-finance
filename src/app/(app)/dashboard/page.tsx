...
export default function DashboardPage() {
  ...
  return (
    <>
      {/* HEADER - Limpo para o Layout mandar */}
      ...
      {/* CARD SALDO - Padding reduzido e borda suavizada */}
      ...
      {/* LIMITES POR CATEGORIA - px-2 para a barra não encostar na borda cinza */}
      <div className="bg-[#111] p-8 rounded-[2rem] border border-white/5 space-y-10 w-full h-full">
              ...
              <div key={meta.id} className="space-y-4">
                <div className="flex justify-between items-end">
                  ...
                  <span className="text-[10px] font-black text-zinc-400 italic">
                    R$ {gastoCat.toLocaleString('pt-BR')}
                  </span>
                </div>
                <div className="w-full bg-white/5 h-3 rounded-full overflow-hidden border border-white/5">
                  <div 
                    className={`h-full transition-all duration-1000 ${progresso >= 90 ? "bg-red-500" : progresso >= 70 ? "bg-orange-500" : "bg-yellow-400"}`} 
      ...
      {/* MODAL DE REGISTRO - Mantenha o arredondamento suave aqui também */}
      {showModal && (
